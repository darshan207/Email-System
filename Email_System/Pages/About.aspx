...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <nav class="navbar navbar-light bg-light" style="overflow:scroll">
      <div class="container-fluid ">
        <img src="../college.png" class="rounded float-start w-25 ">
        <div>
     ...
     <nav class="navbar navbar-light bg-secondary">
        ...
        <div class="container-fluid justify-content-between">
            <div class="card" style="width: 18rem;">
                <img src="../email1.png" class="card-img-top" style="height:200px" >
                <div class="card-body">
            ...
            <div class="card" style="width: 18rem;">
                <img src="../email2.png" class="card-img-top" style="height:200px"  >
                <div class="card-body">
            ...
            <div class="card" style="width: 18rem;">
                <img src="../email3.jpg" class="card-img-top" style="height:200px" >
                <div class="card-body">
